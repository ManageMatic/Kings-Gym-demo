...
export const testimonials: Testimonial[] = [
  {
    ...
    branch: 'Model Town Branch (Surat)',
    rating: 5,
  ...
  },
  {
    ...
    branch: 'Model Town Branch (Surat)',
    rating: 5,
    text: 'I travel between Model Town and Dindoli, and having the multi-branch passport makes my fitness consistency 100%. The royal dark aesthetic truly makes you feel like you are training in a kingdom.',
    avatarInitials: 'RC',
    isDemo: true,
  },
]
