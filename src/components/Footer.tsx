...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white border-t border-zinc-800/90 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-gold-500/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {branches.map((b) => (
              <div
                key={b.id}
                className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800 hover:border-gold-500/40 transition-colors flex flex-col justify-between gap-3"
              >
                <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-gold-400 to-amber-700 flex items-center justify-center border border-gold-300 shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-zinc-400">
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">Strength Training</span></li>
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">Muscle Building</span></li>
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">Metabolic Fat Loss</span></li>
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">Zumba & Dance HIIT</span></li>
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">1-on-1 Personal Training</span></li>
              <li><span className="hover:text-gold-400 transition-colors cursor-pointer">General Functional Fitness</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-zinc-400">
              <div className="flex items-center gap-2">
                ...
                <span>ADD OFFICIAL PHONE</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-gold-400 shrink-0" />
                <span>ADD OFFICIAL EMAIL</span>
              </div>
        ...
        <div className="mt-14 pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={scrollToTop}
              className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-300 hover:text-gold-400 border border-zinc-800 flex items-center gap-1 transition-colors"
